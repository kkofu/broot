...
//! If PowerShell Core (v7.x) is not found the line will be %USERPROFILE%/Documents/WindowsPowerShell/Microsoft.PowerShell_profile.ps1
...
/// returns None if the executable is not present in enviroment path or the call fails
